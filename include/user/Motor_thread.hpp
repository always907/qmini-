...
public:
    std::vector<SerialGroup> serialGroups = {
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAE53JM-if00-port0", {0,5}},//UART4 (上0 1)
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAE53JM-if01-port0", {1,6}},//UART3（髋 0 1）
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAE53JM-if03-port0", {2, 3, 4}},//UART1 (左 0 1 2)
        {"/dev/serial/by-id/usb-FTDI_USB__-__Serial_Converter_FTAE53JM-if02-port0", {7, 8, 9}}//UART2 (右 0 1 2)
...
public:
    ...
    std::array<float, 10> Startq ={0.782437 , 0.231865 , 0.984155 , 0.543862 , 0.819512 , 0.445286 , 0.0262332 , 0.375837 , 0.466011 , 0.228559};
  /* 1左边上身0号电机、
     2 左边髋关节、
     3  右腿0号电机
     4 右膝、
